...
<body>
    <div class="container mt-5">
        ...
        <hr>
        <p class="text-center">กรุณากรอกตัวเลขเพื่อทำการตรวจสอบว่าเป็นเลขคู้หรือเลขคี่
        </p>
        ...
        if ($get_number % 2 == 0) {
            echo "<h3 class='text-danger text-center'>The Number $get_number is an even number</h3>";
        } else {
            echo "<h3 class='text-success text-center'>The Number $get_number is an odd number</h3>";
        }
